...
public class RemoteCommand extends Packet {
	 ...
	 * the hub.
	 */
	public sul.protocol.hncom.types.Address sender;
	...
	public RemoteCommand(byte origin, sul.protocol.hncom.types.Address sender, String command, int commandId) {
		this.origin = origin;
		this.sender = sender;
	...
	public void decode(byte[] buffer) {
		...
		if(origin!=0){ sender=new sul.protocol.hncom.types.Address(); sender._index=this._index; sender.decode(this._buffer); this._index=sender._index; }
