 ...
 */
package sul.protocol.hncom.types;
...
public class GameInfo extends Stream {
	 ...
	 */
	public sul.protocol.hncom.types.Game game;
	...
	public GameInfo(sul.protocol.hncom.types.Game game, String motd, boolean onlineMode, short port) {
		this.game = game;
		this.motd = motd;
	...
	public void decode(byte[] buffer) {
		this._buffer = buffer;
		game=new sul.protocol.hncom.types.Game(); game._index=this._index; game.decode(this._buffer); this._index=game._index;
