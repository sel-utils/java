...
public final class Packets {
	...
	static {
		...
		util.put(1, sul.protocol.hncom.util.Uncompressed.class);
		util.put(2, sul.protocol.hncom.util.Compressed.class);
		UTIL = Collections.unmodifiableMap(util);

		HashMap<Integer, Class<? extends Packet>> login = new HashMap<Integer, Class<? extends Packet>>();
		login.put(3, sul.protocol.hncom.login.ConnectionRequest.class);
		login.put(4, sul.protocol.hncom.login.ConnectionResponse.class);
		login.put(5, sul.protocol.hncom.login.HubInfo.class);
		login.put(6, sul.protocol.hncom.login.NodeInfo.class);
		...
		status.put(7, sul.protocol.hncom.status.AddNode.class);
		status.put(8, sul.protocol.hncom.status.RemoveNode.class);
		status.put(9, sul.protocol.hncom.status.MessageServerbound.class);
		status.put(10, sul.protocol.hncom.status.MessageClientbound.class);
		status.put(11, sul.protocol.hncom.status.Players.class);
		status.put(12, sul.protocol.hncom.status.ResourcesUsage.class);
		status.put(13, sul.protocol.hncom.status.Log.class);
		status.put(14, sul.protocol.hncom.status.RemoteCommand.class);
		status.put(15, sul.protocol.hncom.status.UpdateList.class);
		status.put(16, sul.protocol.hncom.status.Reload.class);
		...
		player.put(17, sul.protocol.hncom.player.Add.class);
		player.put(18, sul.protocol.hncom.player.Remove.class);
		player.put(19, sul.protocol.hncom.player.Kick.class);
		player.put(20, sul.protocol.hncom.player.Transfer.class);
		player.put(21, sul.protocol.hncom.player.UpdateDisplayName.class);
		player.put(22, sul.protocol.hncom.player.UpdateWorld.class);
		player.put(23, sul.protocol.hncom.player.UpdateViewDistance.class);
		player.put(24, sul.protocol.hncom.player.UpdateLanguage.class);
		player.put(25, sul.protocol.hncom.player.UpdateGamemode.class);
		player.put(26, sul.protocol.hncom.player.UpdateInputMode.class);
		player.put(27, sul.protocol.hncom.player.UpdateLatency.class);
		player.put(28, sul.protocol.hncom.player.UpdatePacketLoss.class);
		player.put(29, sul.protocol.hncom.player.GamePacket.class);
		player.put(30, sul.protocol.hncom.player.OrderedGamePacket.class);
		...
		world.put(31, sul.protocol.hncom.world.Add.class);
		world.put(32, sul.protocol.hncom.world.Remove.class);
		world.put(33, sul.protocol.hncom.world.UpdateDifficulty.class);
		world.put(34, sul.protocol.hncom.world.UpdateGamemode.class);
		world.put(35, sul.protocol.hncom.world.RequestCreation.class);
		...
		panel.put(36, sul.protocol.hncom.panel.Connection.class);
