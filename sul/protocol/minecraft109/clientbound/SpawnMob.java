...
public class SpawnMob extends Packet {
	...
	public sul.metadata.Minecraft109 metadata;

	public SpawnMob() {}

	public SpawnMob(int entityId, UUID uuid, byte type, Tuples.DoubleXYZ position, byte yaw, byte pitch, byte headPitch, Tuples.ShortXYZ velocity, sul.metadata.Minecraft109 metadata) {
	...
	@Override
	public int length() {
		return Buffer.varuintLength(entityId) + metadata.length() + 51;
	}
	...
	public void decode(byte[] buffer) {
		...
		metadata=new sul.metadata.Minecraft109(); metadata._index=this._index; metadata.decode(this._buffer); this._index=metadata._index;
	}
