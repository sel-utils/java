...
public class SpawnMob extends Packet {
	...
	public SpawnMob(int entityId, UUID uuid, byte type, Tuples.DoubleXYZ position, byte yaw, byte pitch, byte headPitch, Tuples.ShortXYZ velocity, sul.metadata.Minecraft107 metadata) {
	...
	public void decode(byte[] buffer) {
		...
		metadata=new sul.metadata.Minecraft107(); metadata._index=this._index; metadata.decode(this._buffer); this._index=metadata._index;
	}
