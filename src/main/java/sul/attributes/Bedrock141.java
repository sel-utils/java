 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/bedrock141.xml
 */
package sul.attributes;

public enum Bedrock141
{
    ...
    Bedrock141(String id, float min, float max, float def)
    {
        this.id = id;
        this.min = min;
        this.max = max;
