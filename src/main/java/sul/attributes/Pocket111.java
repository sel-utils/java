 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/pocket111.xml
 */
package sul.attributes;

public enum Pocket111
{
    ...
    Pocket111(String id, float min, float max, float def)
    {
        this.id = id;
        this.min = min;
        this.max = max;
