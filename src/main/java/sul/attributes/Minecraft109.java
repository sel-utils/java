 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/minecraft109.xml
 */
package sul.attributes;

public enum Minecraft109 {
	...
	Minecraft109(String name, float min, float max, float def) {
		this.name = name;
		this.min = min;
		this.max = max;
		this.def = def;
