 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/minecraft333.xml
 */
package sul.attributes;

public enum Minecraft333
{
    ...
    Minecraft333(String id, float min, float max, float def)
    {
        this.id = id;
        this.min = min;
        this.max = max;
