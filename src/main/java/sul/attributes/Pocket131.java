 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/pocket131.xml
 */
package sul.attributes;

public enum Pocket131
{
    ...
    Pocket131(String id, float min, float max, float def)
    {
        this.id = id;
        this.min = min;
        this.max = max;
