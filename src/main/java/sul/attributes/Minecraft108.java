 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/minecraft108.xml
 */
package sul.attributes;

public enum Minecraft108 {
	...
	Minecraft108(String name, float min, float max, float def) {
		this.name = name;
		this.min = min;
		this.max = max;
		this.def = def;
