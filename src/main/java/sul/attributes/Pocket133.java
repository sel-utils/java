 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/pocket133.xml
 */
package sul.attributes;

public enum Pocket133
{
    ...
    Pocket133(String id, float min, float max, float def)
    {
        this.id = id;
        this.min = min;
        this.max = max;
