 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/bedrock160.xml
 */
package sul.attributes;

public enum Bedrock160
{
    ...
    Bedrock160(String id, float min, float max, float def)
    {
        this.id = id;
        this.min = min;
        this.max = max;
