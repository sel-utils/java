...
public class PlayerListItem extends Packet {
	...
	public class AddPlayer extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length); for(sul.protocol.minecraft110.types.ListAddPlayer cxevc:players){ length+=cxevc.length(); } return length;
		}
	...
	public class UpdateGamemode extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length); for(sul.protocol.minecraft110.types.ListUpdateGamemode cxevc:players){ length+=cxevc.length(); } return length;
		}
	...
	public class UpdateLatency extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length); for(sul.protocol.minecraft110.types.ListUpdateLatency cxevc:players){ length+=cxevc.length(); } return length;
		}
	...
	public class UpdateDisplayName extends Packet {
		...
		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length); for(sul.protocol.minecraft110.types.ListUpdateDisplayName cxevc:players){ length+=cxevc.length(); } return length;
		}
