...
public class EntityProperties extends Packet {
	...
	public byte[] encode() {
		...
		this.writeBigEndianInt((int)attributes.length); for(sul.protocol.minecraft110.types.Attribute yrcldrc:attributes){ this.writeBytes(yrcldrc.encode()); }
	...
	public void decode(byte[] buffer) {
		...
		int bfdjyvzm=readBigEndianInt(); attributes=new sul.protocol.minecraft110.types.Attribute[bfdjyvzm]; for(int yrcldrc=0;yrcldrc<attributes.length;yrcldrc++){ attributes[yrcldrc]=new sul.protocol.minecraft110.types.Attribute(); attributes[yrcldrc]._index=this._index; attributes[yrcldrc].decode(this._buffer); this._index=attributes[yrcldrc]._index; }
	}
