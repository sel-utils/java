...
public class ClickWindow extends Packet {
	...
	public ClickWindow(byte window, short slot, byte button, short action, int mode, sul.protocol.minecraft110.types.Slot clickedItem) {
		this.window = window;
		this.slot = slot;
		this.button = button;
		this.action = action;
	...
	public void decode(byte[] buffer) {
		...
		clickedItem=new sul.protocol.minecraft110.types.Slot(); clickedItem._index=this._index; clickedItem.decode(this._buffer); this._index=clickedItem._index;
	}
