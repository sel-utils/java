...
public class AddPlayer extends Packet {
	...
	public float yaw;
	public sul.protocol.pocket111.types.Slot heldItem;
	public sul.metadata.Pocket111 metadata;

	public AddPlayer() {}

	public AddPlayer(UUID uuid, String username, long entityId, long runtimeId, Tuples.FloatXYZ position, Tuples.FloatXYZ motion, float pitch, float headYaw, float yaw, sul.protocol.pocket111.types.Slot heldItem, sul.metadata.Pocket111 metadata) {
		this.uuid = uuid;
	...
	public void decode(byte[] buffer) {
		...
		heldItem=new sul.protocol.pocket111.types.Slot(); heldItem._index=this._index; heldItem.decode(this._buffer); this._index=heldItem._index;
