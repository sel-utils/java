...
public class PlayerList extends Packet {
	...
	public class Add extends Packet {
		...
		public sul.protocol.pocket111.types.PlayerList[] players = new sul.protocol.pocket111.types.PlayerList[0];

		public Add() {}

		public Add(sul.protocol.pocket111.types.PlayerList[] players) {
			this.players = players;
		}

		@Override
		public int length() {
			int length=Buffer.varuintLength(players.length); for(sul.protocol.pocket111.types.PlayerList cxevc:players){ length+=cxevc.length(); } return length;
		}
		...
		public byte[] encode() {
			...
			this.writeVaruint((int)players.length); for(sul.protocol.pocket111.types.PlayerList cxevc:players){ this.writeBytes(cxevc.encode()); }
			return this.getBuffer();
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bbylcm=this.readVaruint(); players=new sul.protocol.pocket111.types.PlayerList[bbylcm]; for(int cxevc=0;cxevc<players.length;cxevc++){ players[cxevc]=new sul.protocol.pocket111.types.PlayerList(); players[cxevc]._index=this._index; players[cxevc].decode(this._buffer); this._index=players[cxevc]._index; }
		}
