...
public class AddPlayer extends Packet {
	...
	public float yaw;
	public sul.protocol.pocket112.types.Slot heldItem;
	...
	public void decode(byte[] buffer) {
		...
		heldItem=new sul.protocol.pocket112.types.Slot(); heldItem._index=this._index; heldItem.decode(this._buffer); this._index=heldItem._index;
