...
public class AddPainting extends Packet {
	...
	public AddPainting(long entityId, long runtimeId, sul.protocol.pocket113.types.BlockPosition position, int direction, String title) {
	...
	public void decode(byte[] buffer) {
		...
		position=new sul.protocol.pocket113.types.BlockPosition(); position._index=this._index; position.decode(this._buffer); this._index=position._index;
