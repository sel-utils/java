...
public class UpdateSign extends Packet {
	...
	@Override
	public int length() {
		int length=10; for(String blzm:lines){ length+=Buffer.varuintLength(blzm.getBytes(StandardCharsets.UTF_8).length)+blzm.getBytes(StandardCharsets.UTF_8).length; } return length;
	}
