...
public class SpawnMob extends Packet {
	...
	public sul.metadata.Java335 metadata;

	public SpawnMob() {}

	public SpawnMob(int entityId, UUID uuid, int type, Tuples.DoubleXYZ position, byte yaw, byte pitch, byte headPitch, Tuples.ShortXYZ velocity, sul.metadata.Java335 metadata) {
	...
	public void decode(byte[] buffer) {
		...
		metadata=new sul.metadata.Java335(); metadata._index=this._index; metadata.decode(this._buffer); this._index=metadata._index;
	}
