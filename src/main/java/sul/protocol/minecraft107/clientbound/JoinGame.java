...
public class JoinGame extends Packet {
	...
	public JoinGame(int entityId, byte gamemode, byte dimension, byte difficulty, byte maxPlayers, String levelType, boolean reducedDebug) {
	...
	@Override
	public int length() {
		return Buffer.varuintLength(levelType.getBytes(StandardCharsets.UTF_8).length) + levelType.getBytes(StandardCharsets.UTF_8).length + 10;
	}
