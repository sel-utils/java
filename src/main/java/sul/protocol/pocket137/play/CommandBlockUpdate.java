...
public class CommandBlockUpdate extends Packet {
	...
	public CommandBlockUpdate(boolean updateBlock, sul.protocol.pocket137.types.BlockPosition position, int mode, boolean redstoneMode, boolean conditional, long minecart, String command, String lastOutput, String hover, boolean trackOutput) {
	...
	public void decode(byte[] buffer) {
		...
		if(updateBlock==true){ position=new sul.protocol.pocket137.types.BlockPosition(); position._index=this._index; position.decode(this._buffer); this._index=position._index; }
