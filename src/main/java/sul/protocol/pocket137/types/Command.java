...
public class Command extends Stream {
	...
	public sul.protocol.pocket137.types.Overload[] overloads = new sul.protocol.pocket137.types.Overload[0];

	public Command() {}

	public Command(String name, String description, byte unknown2, byte permissionLevel, int aliasesEnum, sul.protocol.pocket137.types.Overload[] overloads) {
		this.name = name;
	...
	public byte[] encode() {
		...
		this.writeVaruint((int)overloads.length); for(sul.protocol.pocket137.types.Overload bzcxyr:overloads){ this.writeBytes(bzcxyr.encode()); }
	...
	public void decode(byte[] buffer) {
		...
		int b9zjbfc=this.readVaruint(); overloads=new sul.protocol.pocket137.types.Overload[b9zjbfc]; for(int bzcxyr=0;bzcxyr<overloads.length;bzcxyr++){ overloads[bzcxyr]=new sul.protocol.pocket137.types.Overload(); overloads[bzcxyr]._index=this._index; overloads[bzcxyr].decode(this._buffer); this._index=overloads[bzcxyr]._index; }
	}
