...
public class PlayerList extends Packet {
	...
	public class Add extends Packet {
		...
		public sul.protocol.pocket100.types.PlayerList[] players = new sul.protocol.pocket100.types.PlayerList[0];
		...
		public byte[] encode() {
			...
			this.writeVaruint((int)players.length); for(sul.protocol.pocket100.types.PlayerList cxevc:players){ this.writeBytes(cxevc.encode()); }
			return this.getBuffer();
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bbylcm=this.readVaruint(); players=new sul.protocol.pocket100.types.PlayerList[bbylcm]; for(int cxevc=0;cxevc<players.length;cxevc++){ players[cxevc]=new sul.protocol.pocket100.types.PlayerList(); players[cxevc]._index=this._index; players[cxevc].decode(this._buffer); this._index=players[cxevc]._index; }
		}
