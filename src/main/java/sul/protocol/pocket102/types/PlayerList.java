...
public class PlayerList extends Stream {
	 ...
	 */
	public sul.protocol.pocket102.types.Skin skin;

	public PlayerList() {}

	public PlayerList(UUID uuid, long entityId, String displayName, sul.protocol.pocket102.types.Skin skin) {
		this.uuid = uuid;
	...
	public void decode(byte[] buffer) {
		...
		skin=new sul.protocol.pocket102.types.Skin(); skin._index=this._index; skin.decode(this._buffer); this._index=skin._index;
	}
