...
public class UpdateAttributes extends Packet {
	...
	public UpdateAttributes(long entityId, sul.protocol.pocket102.types.Attribute[] attributes) {
	...
	@Override
	public int length() {
		int length=Buffer.varlongLength(entityId) + Buffer.varuintLength(attributes.length) + 1; for(sul.protocol.pocket102.types.Attribute yrcldrc:attributes){ length+=yrcldrc.length(); } return length;
	}
