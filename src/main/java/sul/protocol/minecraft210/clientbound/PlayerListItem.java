...
public class PlayerListItem extends Packet {
	...
	public class AddPlayer extends Packet {
		...
		public sul.protocol.minecraft210.types.ListAddPlayer[] players = new sul.protocol.minecraft210.types.ListAddPlayer[0];
		...
		public byte[] encode() {
			...
			this.writeVaruint((int)players.length); for(sul.protocol.minecraft210.types.ListAddPlayer cxevc:players){ this.writeBytes(cxevc.encode()); }
			return this.getBuffer();
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bbylcm=this.readVaruint(); players=new sul.protocol.minecraft210.types.ListAddPlayer[bbylcm]; for(int cxevc=0;cxevc<players.length;cxevc++){ players[cxevc]=new sul.protocol.minecraft210.types.ListAddPlayer(); players[cxevc]._index=this._index; players[cxevc].decode(this._buffer); this._index=players[cxevc]._index; }
		}
	...
	public class UpdateGamemode extends Packet {
		...
		public sul.protocol.minecraft210.types.ListUpdateGamemode[] players = new sul.protocol.minecraft210.types.ListUpdateGamemode[0];
		...
		public byte[] encode() {
			...
			this._buffer = new byte[_encode.length + this.length()];
			this.writeBytes(_encode);
			this.writeVaruint((int)players.length); for(sul.protocol.minecraft210.types.ListUpdateGamemode cxevc:players){ this.writeBytes(cxevc.encode()); }
			return this.getBuffer();
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bbylcm=this.readVaruint(); players=new sul.protocol.minecraft210.types.ListUpdateGamemode[bbylcm]; for(int cxevc=0;cxevc<players.length;cxevc++){ players[cxevc]=new sul.protocol.minecraft210.types.ListUpdateGamemode(); players[cxevc]._index=this._index; players[cxevc].decode(this._buffer); this._index=players[cxevc]._index; }
		}
	...
	public class UpdateLatency extends Packet {
		...
		public sul.protocol.minecraft210.types.ListUpdateLatency[] players = new sul.protocol.minecraft210.types.ListUpdateLatency[0];
		...
		public byte[] encode() {
			...
			this._buffer = new byte[_encode.length + this.length()];
			this.writeBytes(_encode);
			this.writeVaruint((int)players.length); for(sul.protocol.minecraft210.types.ListUpdateLatency cxevc:players){ this.writeBytes(cxevc.encode()); }
			return this.getBuffer();
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bbylcm=this.readVaruint(); players=new sul.protocol.minecraft210.types.ListUpdateLatency[bbylcm]; for(int cxevc=0;cxevc<players.length;cxevc++){ players[cxevc]=new sul.protocol.minecraft210.types.ListUpdateLatency(); players[cxevc]._index=this._index; players[cxevc].decode(this._buffer); this._index=players[cxevc]._index; }
		}
	...
	public class UpdateDisplayName extends Packet {
		...
		public sul.protocol.minecraft210.types.ListUpdateDisplayName[] players = new sul.protocol.minecraft210.types.ListUpdateDisplayName[0];
		...
		public byte[] encode() {
			...
			this._buffer = new byte[_encode.length + this.length()];
			this.writeBytes(_encode);
			this.writeVaruint((int)players.length); for(sul.protocol.minecraft210.types.ListUpdateDisplayName cxevc:players){ this.writeBytes(cxevc.encode()); }
			return this.getBuffer();
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bbylcm=this.readVaruint(); players=new sul.protocol.minecraft210.types.ListUpdateDisplayName[bbylcm]; for(int cxevc=0;cxevc<players.length;cxevc++){ players[cxevc]=new sul.protocol.minecraft210.types.ListUpdateDisplayName(); players[cxevc]._index=this._index; players[cxevc].decode(this._buffer); this._index=players[cxevc]._index; }
		}
