...
public class WindowItems extends Packet {
	...
	public WindowItems(byte window, sul.protocol.minecraft210.types.Slot[] slots) {
		this.window = window;
		this.slots = slots;
	}
	...
	public byte[] encode() {
		...
		this.writeBigEndianShort((short)slots.length); for(sul.protocol.minecraft210.types.Slot cxdm:slots){ this.writeBytes(cxdm.encode()); }
	...
	public void decode(byte[] buffer) {
		...
		int bnbr=readBigEndianShort(); slots=new sul.protocol.minecraft210.types.Slot[bnbr]; for(int cxdm=0;cxdm<slots.length;cxdm++){ slots[cxdm]=new sul.protocol.minecraft210.types.Slot(); slots[cxdm]._index=this._index; slots[cxdm].decode(this._buffer); this._index=slots[cxdm]._index; }
	}
