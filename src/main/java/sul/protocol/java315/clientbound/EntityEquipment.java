...
public class EntityEquipment extends Packet {
	...
	public EntityEquipment(int entityId, int slot, sul.protocol.java315.types.Slot item) {
	...
	public void decode(byte[] buffer) {
		...
		item=new sul.protocol.java315.types.Slot(); item._index=this._index; item.decode(this._buffer); this._index=item._index;
	}
