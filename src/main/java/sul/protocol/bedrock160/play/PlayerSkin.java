...
public class PlayerSkin extends Packet {
	...
	public PlayerSkin(sul.protocol.bedrock160.types.McpeUuid uuid, String skinId, String skinName, String unknown3, byte[] skinData, byte[] capeData, String geometryModel, byte[] geometryData) {
		this.uuid = uuid;
		this.skinId = skinId;
