...
public class FullChunkData extends Packet {
	...
	public FullChunkData(Tuples.IntXZ position, sul.protocol.bedrock160.types.ChunkData data) {
	...
	public void decode(byte[] buffer) {
		...
		data=new sul.protocol.bedrock160.types.ChunkData(); data._index=this._index; data.decode(this._buffer); this._index=data._index;
	}
