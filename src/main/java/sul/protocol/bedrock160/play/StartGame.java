...
public class StartGame extends Packet {
	...
	public sul.protocol.bedrock160.types.Rule[] gameRules = new sul.protocol.bedrock160.types.Rule[0];
	...
	public byte[] encode() {
		...
		this.writeVaruint((int)gameRules.length); for(sul.protocol.bedrock160.types.Rule zfzjbv:gameRules){ this.writeBytes(zfzjbv.encode()); }
	...
	public void decode(byte[] buffer) {
		...
		int bdbvdxc=this.readVaruint(); gameRules=new sul.protocol.bedrock160.types.Rule[bdbvdxc]; for(int zfzjbv=0;zfzjbv<gameRules.length;zfzjbv++){ gameRules[zfzjbv]=new sul.protocol.bedrock160.types.Rule(); gameRules[zfzjbv]._index=this._index; gameRules[zfzjbv].decode(this._buffer); this._index=gameRules[zfzjbv]._index; }
