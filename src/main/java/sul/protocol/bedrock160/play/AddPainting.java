...
public class AddPainting extends Packet {
	...
	public AddPainting(long entityId, long runtimeId, sul.protocol.bedrock160.types.BlockPosition position, int direction, String title) {
	...
	public void decode(byte[] buffer) {
		...
		position=new sul.protocol.bedrock160.types.BlockPosition(); position._index=this._index; position.decode(this._buffer); this._index=position._index;
