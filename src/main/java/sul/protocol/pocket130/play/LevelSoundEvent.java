...
public class LevelSoundEvent extends Packet {
	...
	public static final byte SHULKER_BOX_OPEN = 62;
	public static final byte SHULKER_BOX_CLOSE = 63;
	public static final byte POWER_ON = 64;
	public static final byte POWER_OFF = 65;
	public static final byte ATTACH = 66;
	public static final byte DETACH = 67;
	public static final byte DENY = 68;
	public static final byte TRIPOD = 69;
	public static final byte POP = 70;
	public static final byte DROP_SLOT = 71;
	public static final byte NOTE = 72;
	public static final byte THORNS = 73;
	public static final byte PISTON_IN = 74;
	public static final byte PISTON_OUT = 75;
	public static final byte PORTAL = 76;
	public static final byte WATER = 77;
	public static final byte LAVA_POP = 78;
	public static final byte LAVA = 79;
	public static final byte BURP = 80;
	public static final byte BUCKET_FILL_WATER = 81;
	public static final byte BUCKET_FILL_LAVA = 82;
	public static final byte BUCKET_EMPTY_WATER = 83;
	public static final byte BUCKET_EMPTY_LAVA = 84;
	public static final byte GUARDIAN_FLOP = 85;
	public static final byte ELDERGUARDIAN_CURSE = 86;
	public static final byte MOB_WARNING = 87;
	public static final byte MOB_WARNING_BABY = 88;
	public static final byte TELEPORT = 89;
	public static final byte SHULKER_OPEN = 90;
	public static final byte SHULKER_CLOSE = 91;
	public static final byte HAGGLE = 92;
	public static final byte HAGGLE_YES = 93;
	public static final byte HAGGLE_NO = 94;
	public static final byte HAGGLE_IDLE = 95;
	public static final byte CHORUS_GROW = 96;
	public static final byte CHORUS_DEATH = 97;
	public static final byte GLASS = 98;
	public static final byte CAST_SPELL = 99;
	public static final byte PREPARE_ATTACK = 100;
	public static final byte PREPARE_SUMMON = 101;
	public static final byte PREPARE_WOLOLO = 102;
	public static final byte FANG = 103;
	public static final byte CHARGE = 104;
	public static final byte TAKE_PICTURE = 105;
	public static final byte DEFAULT = 106;
	public static final byte UNDEFINED = 107;
