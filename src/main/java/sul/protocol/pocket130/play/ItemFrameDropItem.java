...
public class ItemFrameDropItem extends Packet {
	...
	public ItemFrameDropItem(sul.protocol.pocket130.types.BlockPosition position, sul.protocol.pocket130.types.Slot item) {
	...
	public void decode(byte[] buffer) {
		this._buffer = buffer;
		readBigEndianByte();
		position=new sul.protocol.pocket130.types.BlockPosition(); position._index=this._index; position.decode(this._buffer); this._index=position._index;
