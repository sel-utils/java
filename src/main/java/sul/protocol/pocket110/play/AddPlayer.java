...
public class AddPlayer extends Packet {
	...
	public AddPlayer(UUID uuid, String username, long entityId, long runtimeId, Tuples.FloatXYZ position, Tuples.FloatXYZ motion, float pitch, float headYaw, float yaw, sul.protocol.pocket110.types.Slot heldItem, sul.metadata.Pocket110 metadata) {
		this.uuid = uuid;
	...
	public void decode(byte[] buffer) {
		...
		heldItem=new sul.protocol.pocket110.types.Slot(); heldItem._index=this._index; heldItem.decode(this._buffer); this._index=heldItem._index;
