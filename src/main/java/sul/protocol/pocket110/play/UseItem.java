...
public class UseItem extends Packet {
	...
	public UseItem(sul.protocol.pocket110.types.BlockPosition blockPosition, int hotbarSlot, int face, Tuples.FloatXYZ facePosition, Tuples.FloatXYZ position, int slot, sul.protocol.pocket110.types.Slot item) {
	...
	public void decode(byte[] buffer) {
		this._buffer = buffer;
		readBigEndianByte();
		blockPosition=new sul.protocol.pocket110.types.BlockPosition(); blockPosition._index=this._index; blockPosition.decode(this._buffer); this._index=blockPosition._index;
