...
public class InventoryAction extends Stream {
	...
	public int unknown2;
	public int slot;
	public sul.protocol.pocket133.types.Slot oldItem;
	public sul.protocol.pocket133.types.Slot newItem;

	public InventoryAction() {}

	public InventoryAction(int source, int container, int unknown2, int slot, sul.protocol.pocket133.types.Slot oldItem, sul.protocol.pocket133.types.Slot newItem) {
		this.source = source;
	...
	public void decode(byte[] buffer) {
		...
		oldItem=new sul.protocol.pocket133.types.Slot(); oldItem._index=this._index; oldItem.decode(this._buffer); this._index=oldItem._index;
		newItem=new sul.protocol.pocket133.types.Slot(); newItem._index=this._index; newItem.decode(this._buffer); this._index=newItem._index;
	}
