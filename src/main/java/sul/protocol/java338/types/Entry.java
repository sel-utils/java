...
public class Entry extends Stream {
	...
	public Entry(sul.protocol.java338.types.Slot item, byte craftingSlot, byte playerSlot) {
		this.item = item;
	...
	public void decode(byte[] buffer) {
		this._buffer = buffer;
		item=new sul.protocol.java338.types.Slot(); item._index=this._index; item.decode(this._buffer); this._index=item._index;
