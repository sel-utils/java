...
public class ChunkData extends Stream {
	...
	public sul.protocol.pocket131.types.ExtraData[] extraData = new sul.protocol.pocket131.types.ExtraData[0];
	...
	public ChunkData(sul.protocol.pocket131.types.Section[] sections, short[] heights, byte[] biomes, byte[] borders, sul.protocol.pocket131.types.ExtraData[] extraData, byte[] blockEntities) {
	...
	@Override
	public int length() {
		int length=Buffer.varuintLength(sections.length) + Buffer.varuintLength(borders.length) + borders.length + Buffer.varuintLength(extraData.length) + blockEntities.length + 773; for(sul.protocol.pocket131.types.Section cvdlbm:sections){ length+=cvdlbm.length(); };for(sul.protocol.pocket131.types.ExtraData zhcfyr:extraData){ length+=zhcfyr.length(); } return length;
	}
