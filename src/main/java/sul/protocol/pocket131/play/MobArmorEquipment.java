...
public class MobArmorEquipment extends Packet {
	...
	public sul.protocol.pocket131.types.Slot[] armor = new sul.protocol.pocket131.types.Slot[4];

	public MobArmorEquipment() {}

	public MobArmorEquipment(long entityId, sul.protocol.pocket131.types.Slot[] armor) {
	...
	@Override
	public int length() {
		int length=Buffer.varlongLength(entityId) + 1; for(sul.protocol.pocket131.types.Slot yjbi:armor){ length+=yjbi.length(); } return length;
	}
