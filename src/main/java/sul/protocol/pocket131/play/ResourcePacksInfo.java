...
public class ResourcePacksInfo extends Packet {
	...
	public sul.protocol.pocket131.types.PackWithSize[] behaviourPacks = new sul.protocol.pocket131.types.PackWithSize[0];
	public sul.protocol.pocket131.types.PackWithSize[] resourcePacks = new sul.protocol.pocket131.types.PackWithSize[0];

	public ResourcePacksInfo() {}

	public ResourcePacksInfo(boolean mustAccept, sul.protocol.pocket131.types.PackWithSize[] behaviourPacks, sul.protocol.pocket131.types.PackWithSize[] resourcePacks) {
	...
	@Override
	public int length() {
		int length=6; for(sul.protocol.pocket131.types.PackWithSize yvyzbvuf:behaviourPacks){ length+=yvyzbvuf.length(); };for(sul.protocol.pocket131.types.PackWithSize cvbvyvyn:resourcePacks){ length+=cvbvyvyn.length(); } return length;
	}
