...
public class GameInfo extends Stream {
	...
	public GameInfo(sul.protocol.hncom1.types.Game game, String motd, short port) {
		this.game = game;
		this.motd = motd;
		this.port = port;
	}
	...
	public void decode(byte[] buffer) {
		this._buffer = buffer;
		game=new sul.protocol.hncom1.types.Game(); game._index=this._index; game.decode(this._buffer); this._index=game._index;
