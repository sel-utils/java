...
public class SpawnMob extends Packet {
	...
	public sul.metadata.Java210 metadata;

	public SpawnMob() {}

	public SpawnMob(int entityId, UUID uuid, byte type, Tuples.DoubleXYZ position, byte yaw, byte pitch, byte headPitch, Tuples.ShortXYZ velocity, sul.metadata.Java210 metadata) {
	...
	public void decode(byte[] buffer) {
		...
		metadata=new sul.metadata.Java210(); metadata._index=this._index; metadata.decode(this._buffer); this._index=metadata._index;
	}
