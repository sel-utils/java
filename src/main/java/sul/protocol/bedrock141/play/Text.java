...
public class Text extends Packet {
	...
	public class Raw extends Packet {
		...
		@Override
		public int length() {
			return Buffer.varuintLength(message.getBytes(StandardCharsets.UTF_8).length) + message.getBytes(StandardCharsets.UTF_8).length + Buffer.varuintLength(xuid.getBytes(StandardCharsets.UTF_8).length) + xuid.getBytes(StandardCharsets.UTF_8).length;
		}
		...
		@Override
		public String toString() {
			return "Text.Raw(message: " + this.message + ", xuid: " + this.xuid + ")";
		}
	...
	public class Chat extends Packet {
		...
		@Override
		public int length() {
			return Buffer.varuintLength(sender.getBytes(StandardCharsets.UTF_8).length) + sender.getBytes(StandardCharsets.UTF_8).length + Buffer.varuintLength(message.getBytes(StandardCharsets.UTF_8).length) + message.getBytes(StandardCharsets.UTF_8).length + Buffer.varuintLength(xuid.getBytes(StandardCharsets.UTF_8).length) + xuid.getBytes(StandardCharsets.UTF_8).length;
		}
		...
		@Override
		public String toString() {
			return "Text.Chat(sender: " + this.sender + ", message: " + this.message + ", xuid: " + this.xuid + ")";
		}
	...
	public class JukeboxPopup extends Packet {
		...
		@Override
		public String toString() {
			return "Text.JukeboxPopup(message: " + this.message + ", parameters: " + Arrays.deepToString(this.parameters) + ")";
		}
	...
	public class Announcement extends Packet {
		...
		public static final byte TYPE = (byte)8;
