...
public class AddPainting extends Packet {
	...
	public sul.protocol.pocket134.types.BlockPosition position;
	public int direction;
	public String title;

	public AddPainting() {}

	public AddPainting(long entityId, long runtimeId, sul.protocol.pocket134.types.BlockPosition position, int direction, String title) {
	...
	@Override
	public int length() {
		return Buffer.varlongLength(entityId) + Buffer.varulongLength(runtimeId) + position.length() + Buffer.varintLength(direction) + Buffer.varuintLength(title.getBytes(StandardCharsets.UTF_8).length) + title.getBytes(StandardCharsets.UTF_8).length + 1;
	}
	...
	public void decode(byte[] buffer) {
		...
		position=new sul.protocol.pocket134.types.BlockPosition(); position._index=this._index; position.decode(this._buffer); this._index=position._index;
