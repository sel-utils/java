...
public class Login extends Packet {
	 ...
	 */
	public sul.protocol.pocket134.types.LoginBody body;

	public Login() {}

	public Login(int protocol, sul.protocol.pocket134.types.LoginBody body) {
	...
	public void decode(byte[] buffer) {
		...
		body=new sul.protocol.pocket134.types.LoginBody(); body._index=this._index; body.decode(this._buffer); this._index=body._index;
	}
