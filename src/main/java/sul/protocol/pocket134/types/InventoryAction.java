...
public class InventoryAction extends Stream {
	...
	public InventoryAction(int source, int container, int unknown2, int slot, sul.protocol.pocket134.types.Slot oldItem, sul.protocol.pocket134.types.Slot newItem) {
		this.source = source;
	...
	public void decode(byte[] buffer) {
		...
		oldItem=new sul.protocol.pocket134.types.Slot(); oldItem._index=this._index; oldItem.decode(this._buffer); this._index=oldItem._index;
		newItem=new sul.protocol.pocket134.types.Slot(); newItem._index=this._index; newItem.decode(this._buffer); this._index=newItem._index;
	}
