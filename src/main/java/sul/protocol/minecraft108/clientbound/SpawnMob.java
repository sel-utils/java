...
public class SpawnMob extends Packet {
	...
	public SpawnMob(int entityId, UUID uuid, byte type, Tuples.DoubleXYZ position, byte yaw, byte pitch, byte headPitch, Tuples.ShortXYZ velocity, sul.metadata.Minecraft108 metadata) {
