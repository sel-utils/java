...
public class Bedrock141 extends Stream {
		...
		while(length-- > 0) {
			...
			switch(readLittleEndianByte()) {
				...
				case 4:
					...
					break;
				case 5:
					sul.protocol.bedrock141.types.Slot _5;
					_5=new sul.protocol.bedrock141.types.Slot(); _5._index=this._index; _5.decode(this._buffer); this._index=_5._index;
					break;
				case 6:
					Tuples.IntXYZ _6;
