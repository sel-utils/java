 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/metadata/pocket113.xml
 */
...
public class Pocket113 extends Stream {
		...
		while(length-- > 0) {
			...
			switch(readBigEndianByte()) {
				...
				case 5:
					...
					_5=new sul.protocol.pocket113.types.Slot(); _5._index=this._index; _5.decode(this._buffer); this._index=_5._index;
					break;
				case 6:
					Tuples.IntXYZ _6;
