 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/metadata/bedrock150.xml
 */
...
public class Bedrock150 extends Stream {
		...
		while(length-- > 0) {
			...
			switch(readLittleEndianByte()) {
				...
				case 4:
					...
					break;
				case 5:
					sul.protocol.bedrock150.types.Slot _5;
					_5=new sul.protocol.bedrock150.types.Slot(); _5._index=this._index; _5.decode(this._buffer); this._index=_5._index;
					break;
				case 6:
					Tuples.IntXYZ _6;
