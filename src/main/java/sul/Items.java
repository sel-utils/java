...
public final class Items
{
    ...
    static
    {
        ...
        add(POTION = new Items("potion", new ItemData(373, 0), new ItemData(373, 0), (byte)1, (short)0));
        ...
        add(SPAWN_ELDER_GUARDIAN = new Items("spawn elder guardian", new ItemData(383, 4), new ItemData(383, 50), (byte)64, (short)0));
        add(SPAWN_WITHER_SKELETON = new Items("spawn wither skeleton", new ItemData(383, 5), new ItemData(383, 48), (byte)64, (short)0));
        add(SPAWN_STRAY = new Items("spawn stray", new ItemData(383, 6), new ItemData(383, 46), (byte)64, (short)0));
        add(SPAWN_HUSK = new Items("spawn husk", new ItemData(383, 23), new ItemData(383, 47), (byte)64, (short)0));
        add(SPAWN_ZOMBIE_VILLAGER = new Items("spawn zombie villager", new ItemData(383, 27), new ItemData(383, 44), (byte)64, (short)0));
        add(SPAWN_SKELETON_HORSE = new Items("spawn skeleton horse", new ItemData(383, 28), new ItemData(383, 26), (byte)64, (short)0));
        add(SPAWN_ZOMBIE_HORSE = new Items("spawn zombie horse", new ItemData(383, 29), new ItemData(383, 27), (byte)64, (short)0));
        add(SPAWN_DONKEY = new Items("spawn donkey", new ItemData(383, 31), new ItemData(383, 24), (byte)64, (short)0));
        add(SPAWN_MULE = new Items("spawn mule", new ItemData(383, 32), new ItemData(383, 25), (byte)64, (short)0));
        add(SPAWN_EVOKER = new Items("spawn evoker", new ItemData(383, 34), new ItemData(383, 104), (byte)64, (short)0));
        add(SPAWN_VEX = new Items("spawn vex", new ItemData(383, 35), new ItemData(383, 105), (byte)64, (short)0));
        add(SPAWN_VINDICATOR = new Items("spawn vindicator", new ItemData(383, 36), new ItemData(383, 56), (byte)64, (short)0));
        add(SPAWN_CREEPER = new Items("spawn creeper", new ItemData(383, 50), new ItemData(383, 33), (byte)64, (short)0));
        add(SPAWN_SKELETON = new Items("spawn skeleton", new ItemData(383, 51), new ItemData(383, 34), (byte)64, (short)0));
        add(SPAWN_SPIDER = new Items("spawn spider", new ItemData(383, 52), new ItemData(383, 35), (byte)64, (short)0));
        add(SPAWN_ZOMBIE = new Items("spawn zombie", new ItemData(383, 54), new ItemData(383, 32), (byte)64, (short)0));
        add(SPAWN_SLIME = new Items("spawn slime", new ItemData(383, 55), new ItemData(383, 37), (byte)64, (short)0));
        add(SPAWN_GHAST = new Items("spawn ghast", new ItemData(383, 56), new ItemData(383, 41), (byte)64, (short)0));
        add(SPAWN_ZOMBIE_PIGMAN = new Items("spawn zombie pigman", new ItemData(383, 57), new ItemData(383, 36), (byte)64, (short)0));
        add(SPAWN_ENDERMAN = new Items("spawn enderman", new ItemData(383, 58), new ItemData(383, 38), (byte)64, (short)0));
        add(SPAWN_CAVE_SPIDER = new Items("spawn cave spider", new ItemData(383, 59), new ItemData(383, 40), (byte)64, (short)0));
        add(SPAWN_SILVERFISH = new Items("spawn silverfish", new ItemData(383, 60), new ItemData(383, 39), (byte)64, (short)0));
        add(SPAWN_BLAZE = new Items("spawn blaze", new ItemData(383, 61), new ItemData(383, 43), (byte)64, (short)0));
        add(SPAWN_MAGMA_CUBE = new Items("spawn magma cube", new ItemData(383, 62), new ItemData(383, 42), (byte)64, (short)0));
        add(SPAWN_BAT = new Items("spawn bat", new ItemData(383, 65), new ItemData(383, 19), (byte)64, (short)0));
        add(SPAWN_WITCH = new Items("spawn witch", new ItemData(383, 66), new ItemData(383, 45), (byte)64, (short)0));
        add(SPAWN_ENDERMITE = new Items("spawn endermite", new ItemData(383, 67), new ItemData(383, 55), (byte)64, (short)0));
        add(SPAWN_GUARDIAN = new Items("spawn guardian", new ItemData(383, 68), new ItemData(383, 49), (byte)64, (short)0));
        add(SPAWN_SHULKER = new Items("spawn shulker", new ItemData(383, 69), new ItemData(383, 54), (byte)64, (short)0));
        add(SPAWN_PIG = new Items("spawn pig", new ItemData(383, 90), new ItemData(383, 12), (byte)64, (short)0));
        add(SPAWN_SHEEP = new Items("spawn sheep", new ItemData(383, 91), new ItemData(383, 13), (byte)64, (short)0));
        add(SPAWN_COW = new Items("spawn cow", new ItemData(383, 92), new ItemData(383, 11), (byte)64, (short)0));
        add(SPAWN_CHICKEN = new Items("spawn chicken", new ItemData(383, 93), new ItemData(383, 10), (byte)64, (short)0));
        add(SPAWN_SQUID = new Items("spawn squid", new ItemData(383, 94), new ItemData(383, 17), (byte)64, (short)0));
        add(SPAWN_WOLF = new Items("spawn wolf", new ItemData(383, 95), new ItemData(383, 14), (byte)64, (short)0));
        add(SPAWN_MOOSHROOM = new Items("spawn mooshroom", new ItemData(383, 96), new ItemData(383, 16), (byte)64, (short)0));
        add(SPAWN_OCELOT = new Items("spawn ocelot", new ItemData(383, 98), new ItemData(383, 22), (byte)64, (short)0));
        add(SPAWN_HORSE = new Items("spawn horse", new ItemData(383, 100), new ItemData(383, 23), (byte)64, (short)0));
        add(SPAWN_RABBIT = new Items("spawn rabbit", new ItemData(383, 101), new ItemData(383, 18), (byte)64, (short)0));
        add(SPAWN_POLAR_BEAR = new Items("spawn polar bear", new ItemData(383, 102), new ItemData(383, 28), (byte)64, (short)0));
        add(SPAWN_LLAMA = new Items("spawn llama", new ItemData(383, 103), new ItemData(383, 29), (byte)64, (short)0));
        add(SPAWN_PARROT = new Items("spawn parrot", new ItemData(383, 105), null, (byte)64, (short)0));
        add(SPAWN_VILLAGER = new Items("spawn villager", new ItemData(383, 120), new ItemData(383, 15), (byte)64, (short)0));
        ...
        add(SPLASH_POTION = new Items("splash potion", new ItemData(438, 0), new ItemData(438, 0), (byte)1, (short)0));
        add(SPECTRAL_ARROW = new Items("spectral arrow", new ItemData(439, 0), null, (byte)64, (short)0));
        add(TIPPED_ARROW = new Items("tipped arrow", new ItemData(440, 0), new ItemData(440, 0), (byte)64, (short)0));
        add(LINGERING_POTION = new Items("lingering potion", new ItemData(441, 0), new ItemData(441, 0), (byte)1, (short)0));
