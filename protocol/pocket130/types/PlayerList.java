...
public class PlayerList extends Stream {
	...
	public PlayerList(sul.protocol.pocket130.types.McpeUuid uuid, long entityId, String displayName, sul.protocol.pocket130.types.Skin skin) {
		this.uuid = uuid;
	...
	public void decode(byte[] buffer) {
		...
		skin=new sul.protocol.pocket130.types.Skin(); skin._index=this._index; skin.decode(this._buffer); this._index=skin._index;
	}
