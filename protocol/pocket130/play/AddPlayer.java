...
public class AddPlayer extends Packet {
	...
	public AddPlayer(sul.protocol.pocket130.types.McpeUuid uuid, String username, long entityId, long runtimeId, Tuples.FloatXYZ position, Tuples.FloatXYZ motion, float pitch, float headYaw, float yaw, sul.protocol.pocket130.types.Slot heldItem, sul.metadata.Pocket130 metadata) {
		this.uuid = uuid;
	...
	public void decode(byte[] buffer) {
		...
		heldItem=new sul.protocol.pocket130.types.Slot(); heldItem._index=this._index; heldItem.decode(this._buffer); this._index=heldItem._index;
