...
public class ResourcePacksStackPacket extends Packet {
	...
	public sul.protocol.pocket131.types.Pack[] behaviourPacks = new sul.protocol.pocket131.types.Pack[0];
	public sul.protocol.pocket131.types.Pack[] resourcePacks = new sul.protocol.pocket131.types.Pack[0];

	public ResourcePacksStackPacket() {}

	public ResourcePacksStackPacket(boolean mustAccept, sul.protocol.pocket131.types.Pack[] behaviourPacks, sul.protocol.pocket131.types.Pack[] resourcePacks) {
	...
	@Override
	public int length() {
		int length=Buffer.varuintLength(behaviourPacks.length) + Buffer.varuintLength(resourcePacks.length) + 2; for(sul.protocol.pocket131.types.Pack yvyzbvuf:behaviourPacks){ length+=yvyzbvuf.length(); };for(sul.protocol.pocket131.types.Pack cvbvyvyn:resourcePacks){ length+=cvbvyvyn.length(); } return length;
	}
