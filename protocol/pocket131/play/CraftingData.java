...
public class CraftingData extends Packet {
	...
	public sul.protocol.pocket131.types.Recipe[] recipes = new sul.protocol.pocket131.types.Recipe[0];

	public CraftingData() {}

	public CraftingData(sul.protocol.pocket131.types.Recipe[] recipes) {
		this.recipes = recipes;
	}

	@Override
	public int length() {
		int length=Buffer.varuintLength(recipes.length) + 1; for(sul.protocol.pocket131.types.Recipe cvabc:recipes){ length+=cvabc.length(); } return length;
	}
