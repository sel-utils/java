...
public class Explode extends Packet {
	...
	public float radius;
	public sul.protocol.pocket131.types.BlockPosition[] destroyedBlocks = new sul.protocol.pocket131.types.BlockPosition[0];

	public Explode() {}

	public Explode(Tuples.FloatXYZ position, float radius, sul.protocol.pocket131.types.BlockPosition[] destroyedBlocks) {
	...
	@Override
	public int length() {
		int length=Buffer.varuintLength(destroyedBlocks.length) + 17; for(sul.protocol.pocket131.types.BlockPosition zvdjevqx:destroyedBlocks){ length+=zvdjevqx.length(); } return length;
	}
