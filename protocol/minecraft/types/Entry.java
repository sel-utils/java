...
public class Entry extends Stream {
	...
	public sul.protocol.minecraft.types.Slot item;
	public byte craftingSlot;
	public byte playerSlot;

	public Entry() {}

	public Entry(sul.protocol.minecraft.types.Slot item, byte craftingSlot, byte playerSlot) {
		this.item = item;
	...
	public void decode(byte[] buffer) {
		this._buffer = buffer;
		item=new sul.protocol.minecraft.types.Slot(); item._index=this._index; item.decode(this._buffer); this._index=item._index;
