...
public class Add extends Packet {
	 ...
	 */
	public sul.protocol.hncom.types.Address clientAddress;
	 ...
	 * mode.
	 */
	public sul.protocol.hncom.types.Skin skin;
	...
	public Add(int hubId, byte reason, byte type, int protocol, String version, String username, String displayName, byte dimension, int viewDistance, sul.protocol.hncom.types.Address clientAddress, String serverAddress, short serverPort, UUID uuid, sul.protocol.hncom.types.Skin skin, String language, byte inputMode, int latency) {
		this.hubId = hubId;
		this.reason = reason;
		this.type = type;
	...
	public void decode(byte[] buffer) {
		...
		clientAddress=new sul.protocol.hncom.types.Address(); clientAddress._index=this._index; clientAddress.decode(this._buffer); this._index=clientAddress._index;
		...
		skin=new sul.protocol.hncom.types.Skin(); skin._index=this._index; skin.decode(this._buffer); this._index=skin._index;
	...
	public class Minecraft extends Packet {
		 ...
		 */
		public sul.protocol.hncom.types.Property[] properties = new sul.protocol.hncom.types.Property[0];

		public Minecraft() {}

		public Minecraft(sul.protocol.hncom.types.Property[] properties) {
			this.properties = properties;
		}

		@Override
		public int length() {
			int length=Buffer.varuintLength(properties.length); for(sul.protocol.hncom.types.Property cjcvdlc:properties){ length+=cjcvdlc.length(); } return length;
		}
		...
		public byte[] encode() {
			...
			this._buffer = new byte[_encode.length + this.length()];
			this.writeBytes(_encode);
			this.writeVaruint((int)properties.length); for(sul.protocol.hncom.types.Property cjcvdlc:properties){ this.writeBytes(cjcvdlc.encode()); }
			return this.getBuffer();
		}
		...
		public void decode(byte[] buffer) {
			this._buffer = buffer;
			int bbbbcrzm=this.readVaruint(); properties=new sul.protocol.hncom.types.Property[bbbbcrzm]; for(int cjcvdlc=0;cjcvdlc<properties.length;cjcvdlc++){ properties[cjcvdlc]=new sul.protocol.hncom.types.Property(); properties[cjcvdlc]._index=this._index; properties[cjcvdlc].decode(this._buffer); this._index=properties[cjcvdlc]._index; }
		}
