...
public class ConsoleMessage extends Packet {
	...
	public ConsoleMessage(String node, long timestamp, String logger, String message, int commandId) {
		this.node = node;
	...
	@Override
	public int length() {
		return node.getBytes(StandardCharsets.UTF_8).length + logger.getBytes(StandardCharsets.UTF_8).length + message.getBytes(StandardCharsets.UTF_8).length + 19;
	}
	...
	public String toString() {
		return "ConsoleMessage(node: " + this.node + ", timestamp: " + this.timestamp + ", logger: " + this.logger + ", message: " + this.message + ", commandId: " + this.commandId + ")";
	}
