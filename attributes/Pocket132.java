 ...
 * Generated from https://github.com/sel-project/sel-utils/blob/master/xml/attributes/pocket132.xml
 */
package sul.attributes;

public enum Pocket132
{
    ...
    Pocket132(String id, float min, float max, float def)
    {
        this.id = id;
        this.min = min;
        this.max = max;
