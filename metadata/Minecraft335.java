...
public class Minecraft335 extends Stream {
		...
		while(!this.eof() && (metadata=readBigEndianByte()) != (byte)255) {
			switch(readBigEndianByte()) {
				...
				case 5:
					...
					_5=new sul.protocol.minecraft335.types.Slot(); _5._index=this._index; _5.decode(this._buffer); this._index=_5._index;
					break;
				case 6:
					boolean _6;
					_6=this.readBool();
				...
				case 9:
					...
					_9=new sul.protocol.minecraft335.types.OptionalPosition(); _9._index=this._index; _9.decode(this._buffer); this._index=_9._index;
					break;
				case 10:
					int _10;
				...
				case 11:
					...
					_11=new sul.protocol.minecraft335.types.OptionalUuid(); _11._index=this._index; _11.decode(this._buffer); this._index=_11._index;
					break;
				case 12:
					int _12;
